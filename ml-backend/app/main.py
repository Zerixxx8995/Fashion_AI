...
from app.routers import cv, health, trends, wardrobe, budget, recommendations, explanations, agent, review_explain
...
def create_app() -> FastAPI:
    ...
    app.include_router(review_explain.router, prefix="/api/v1")
